!(function (e) {
  ...
  "use strict";
  var h, c, n, a, p, d, e, u, g, v, l, r, f, S, m, T, y, b, w, x, $, H, C, O, A;
  function t(t, e) {
    (this.el = t),
      (this.options = e),
      (c = c || w()),
  ...
  (b = {
      ...
      this.events = {
        down: function (t) {
          return (
            ...
            h.doc.bind(g, h.events[p]).bind(v, h.events.up),
            h.body.bind(u, h.events[d]),
            !1
          );
        },
        drag: function (t) {
        ...
        up: function (t) {
          return (
            ...
            l.doc.unbind(g, l.events[p]).unbind(v, l.events.up),
            l.body.unbind(u, l.events[d]),
            !1
          );
        },
        resize: function (t) {
        ...
        panedown: function (t) {
          return (
            (o.sliderY =
              (t.offsetY || t.originalEvent.layerY) - 0.5 * o.sliderHeight),
            o.scroll(),
            o.events.down(t),
            !1
          );
        ...
        scroll: function (t) {
          s.updateScrollValues(),
            s.isBeingDragged ||
              (s.iOSNativeScrolling ||
                ((s.sliderY = s.sliderTop), s.setOnScrollStyles()),
              null != t &&
                (s.contentScrollTop >= s.maxScrollTop
                  ? (s.options.preventPageScrolling && s.preventScrolling(t, a),
                    s.prevScrollTop !== s.maxScrollTop &&
                      s.$el.trigger("scrollend"))
                  : 0 === s.contentScrollTop &&
                    (s.options.preventPageScrolling && s.preventScrolling(t, T),
                    0 !== s.prevScrollTop && s.$el.trigger("scrolltop"))));
        },
        wheel: function (t) {
          if (null != t)
            return (
        ...
        enter:
          ((e = i = s = o = n = l = r = h = this),
          function (t) {
            if (e.isBeingDragged)
              return 1 !== (t.buttons || t.which)
                ? (t = e.events).up.apply(t, arguments)
                : void 0;
          }),
      };
    }),
    (t.prototype.addEvents = function () {
      ...
      this.removeEvents(),
        ...
        this.$content.bind(S + " " + l + " " + n + " " + m, t[S]);
    }),
    (t.prototype.removeEvents = function () {
      var t = this.events;
      this.win.unbind(f, t[f]),
        this.iOSNativeScrolling || (this.slider.unbind(), this.pane.unbind()),
        this.$content.unbind(S + " " + l + " " + n + " " + m, t[S]);
    }),
    (t.prototype.generate = function () {
      ...
      return (
        ...
        0 === c && $()
          ...
          : c && ((t = { right: -c }), this.$el.addClass("has-scrollbar")),
    ...
    (t.prototype.reset = function () {
      ...
      if (!this.iOSNativeScrolling)
        return (
          ...
          (i = (e = (t = this.content).style).overflowY),
          h && this.$content.css({ height: this.$content.height() }),
          (l = t.scrollHeight + c),
          0 < (n = parseInt(this.$el.css("max-height"), 10)) &&
            (this.$el.height(""),
            this.$el.height(t.scrollHeight > n ? n : t.scrollHeight)),
          (s =
            (n = this.pane.outerHeight(!1)) +
            (o = parseInt(this.pane.css("top"), 10)) +
            parseInt(this.pane.css("bottom"), 10)),
          (r = Math.round((s / l) * n)) < this.options.sliderMinHeight
            ? (r = this.options.sliderMinHeight)
            : null != this.options.sliderMaxHeight &&
              r > this.options.sliderMaxHeight &&
              (r = this.options.sliderMaxHeight),
          i === S && e.overflowX !== S && (r += c),
          (this.maxSliderTop = s - r),
          (this.contentHeight = l),
          (this.paneHeight = n),
          (this.paneOuterHeight = s),
          (this.sliderHeight = r),
          (this.paneTop = o),
          this.slider.height(r),
          this.events.scroll(),
          this.pane.show(),
          (this.isActive = !0),
          t.scrollHeight === t.clientHeight ||
          (this.pane.outerHeight(!0) >= t.scrollHeight && i !== S)
            ? (this.pane.hide(), (this.isActive = !1))
            : this.el.clientHeight === t.scrollHeight && i === S
            ? this.slider.hide()
            : this.slider.show(),
          this.pane.css({
          ...
          ("static" !== (e = this.$content.css("position")) &&
            "relative" !== e) ||
            ((l = parseInt(this.$content.css("right"), 10)) &&
              this.$content.css({ right: "", marginRight: l })),
          this
        );
