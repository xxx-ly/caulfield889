  ...
  class g extends a {
    ...
    onInitSlide(t, e) {
      ...
      i &&
        ...
        (e[p] = parseFloat(i[p] || "") || e[p] || 0),
        (e[b] = parseFloat(i.thumbHeight || "") || e[b] || 0)),
        this.addSlide(e);
    }
    onInitSlides() {
      this.build();
    ...
    onChange() {
      ...
      if (r && o && a) {
        if (r.isDragging) {
          n(e, this.cn(d));
          let i =
            (null === (t = o.pages[l]) || void 0 === t ? void 0 : t.pos) || 0;
          i += s.getProgress(l) * (this[p] + this.thumbGap);
          let r = a.getBounds();
          -1 * i > r.x.min &&
            -1 * i < r.x.max &&
            a.panTo({ x: -1 * i, friction: 0.12 });
        } else
          (c = e),
            (u = this.cn(d)),
            (h = r.isResting),
    ...
    resizeModernSlide(t) {
      this.isModern &&
        (t[f] = t[p] && t[b] ? Math.round(this[b] * (t[p] / t[b])) : this[f]);
    }
    updateProps() {
      ...
      (this.thumbGap = e("gap")),
        ...
        (this[f] = e("width") || 40),
        (this[p] = e("clip-width") || 40),
        (this[b] = e("height") || 40);
    }
    build() {
      const i = this;
      if (i.state !== t.States.Init) return;
      if (i.isDisabled()) return void i.emit("disabled");
      const n = i.instance,
        r = n.container,
        o = i.getSlides(),
        a = i.option("type");
      i.type = a;
      const l = i.option("parentEl"),
        c = i.cn("container"),
        u = i.cn("track");
      let h = null == l ? void 0 : l.querySelector("." + c);
      h ||
        ((h = document.createElement("div")),
        s(h, c),
        l ? l.appendChild(h) : r.after(h)),
        s(h, `is-${a}`),
        s(r, i.cn("hasThumbs")),
        (i.container = h),
        i.updateProps();
      let d = h.querySelector("." + u);
      d ||
      ...
      const f = e(
          ...
          i.option("Carousel") || {},
          { Sync: { target: n }, slides: o }
        ),
        b = new n.constructor(h, f);
      b.on("createSlide", (t, e) => {
        i.setProps(e.index), i.emit("createSlide", e, e.el);
      }),
        b.on("ready", () => {
          i.shiftModern(), i.emit("ready");
        }),
        b.on("refresh", () => {
          i.shiftModern();
        }),
        b.on("Panzoom.click", (t, e, s) => {
          i.onClick(s);
        }),
        (i.carousel = b),
        (i.state = t.States.Ready);
    }
    onClick(t) {
      ...
      d && b
        ? ((o =
            Math.abs(c - d.getBoundingClientRect().right) <
    ...
    getShift(t) {
      ...
      return (
        0 === t
          ? ((g = m * Math.abs(h)), v && 1 === h && (g -= m * Math.abs(d)))
          : t === u
          ? ((g = m * Math.abs(d) * -1),
            y && -1 === d && (g += m * Math.abs(h)))
          : y || v
          ? ((g = -1 * m), (g += m * Math.abs(h)), (g += m * (1 - Math.abs(d))))
          : (g = m * b),
        g
      );
    }
    setProps(t) {
      ...
      if (s && n) {
        ...
        if (r && r.childNodes.length) {
          let e = u(1 - Math.abs(s.getProgress(t))),
            n = u(i.getShift(t));
          r.style.setProperty("--progress", e ? e + "" : ""),
            r.style.setProperty("--shift", n + "");
        }
      }
    }
    shiftModern() {
      ...
      const { instance: e, track: i } = t,
        ...
        n = t.carousel;
      if (!(e && i && s && n)) return;
      if (s.state === l.Init || s.state === l.Destroy) return;
      for (const i of e.slides) t.setProps(i.index);
      let r = (t[p] + t.thumbGap) * (n.slides.length || 0);
    ...
    cleanup() {
      ...
      e.carousel && e.carousel.destroy(),
        ...
        (e.track = null),
        (e.state = t.States.Init),
        n(e.instance.container, e.cn("hasThumbs"));
    }
    attach() {
      const t = this,
        e = t.instance;
